...
var App=new Vue({
	...
	methods:{
		...
		goGuest:function(){
			window.location="/module.php?m=pdd_guest&a=user&shopid="+shopid;
		},
		...
		getPin:function(){
			var that = this;
			$.ajax({
				url:"/module.php?m=pdd_shop&a=pinlist&ajax=1&shopid=" + shopid,
				dataType:"json",
				success: function(res) {
					that.pinList= res.data.pts;
		 
				}
			});
		},
		goProduct:function(id){
			window.location="/module.php?m=pdd_product&a=show&id="+id+"&shopid="+shopid
		},
		getProduct:function(){
			var that=this;
			$.ajax({
				url:"/module.php?m=pdd_product&ajax=1&shopid="+shopid,
				data:{
					catid:that.catid,
		...
		getRaty:function(){
			var that=this;
			$.ajax({
				url:"/module.php?m=pdd_shop&a=raty&ajax=1&shopid="+shopid,
				dataType:"json",
				success:function(res){
		...
		getDetail:function(){
			var that=this;
			$.ajax({
				url:"/module.php?m=pdd_shop&a=detail&ajax=1&shopid="+shopid,
				dataType:"json",
				success:function(res){
