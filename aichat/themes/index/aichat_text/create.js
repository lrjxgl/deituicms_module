var App=new Vue({
	...
	methods:{
		getPrompt:function(){
			var that=this;
			$.ajax({
				url:"/module.php?m=aichat_text_prompt&ajax=1&limit=6",
		...
		getQueue:function(item){
			var that=this;
			$.ajax({
				url:"/module.php?m=aichat_text&a=queuenum&ajax=1",
		...
		getImg:function(imgid){
			var that=this;
			$.ajax({
				url:"/module.php?m=aichat_text&a=get&ajax=1",
				data:{
					id:imgid
				},
				dataType:"json",
		...
		createImg:function(){
			...
			$.ajax({
				...
				url:"/module.php?m=aichat_text&a=createsave&ajax=1",
				type:"POST",
				dataType:"json",
				data:{
					prompt:that.prompt
