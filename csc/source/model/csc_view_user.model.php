<?php
class csc_view_userModel extends model{
	public $table="mod_csc_view_user";
	...
	public function add($shopid,$userid){
		...
		if($row){
			...
			MM("csc","csc_push")->sendShop(array(
				"table"=>"mod_csc_shop",
				"shopid"=>$shopid,
				"content"=>array(
				...
				"url"=>HTTP_HOST."/shopadmin.php?m=csc_view_user&type=view",
				"linkurl"=>array(
					"path"=>"/moduleshop.php",
					"m"=>"csc_view_user",
					"a"=>"view",
