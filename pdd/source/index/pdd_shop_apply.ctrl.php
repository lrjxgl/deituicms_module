...
class pdd_shop_applyControl extends skymvc{
	...
	public function onDefault(){
		...
		$apply=M("mod_pdd_shop_apply")->selectRow("userid=".$userid);
	...
	public function onSendSms(){
		...
		$exkey="pddshopapplysms".$telephone;
		$key="pddshopapplysms".$telephone.$yzm;
		$t=cache()->get($exkey);
		if($t){
	...
	public function onSave(){
		...
		$data=M("mod_pdd_shop_apply")->postData();
		...
		$data["userid"]=$userid;
		M("mod_pdd_shop_apply")->insert($data);
