var app=new Vue({
	...
	methods:{
		...
		getPage:function(){
			var that=this;
			$.ajax({
				url:"/moduleshop.php?m=mmjz_product&ajax=1",
				dataType:"json",
		...
		statusToggle:function(item){
			$.ajax({
				url:"/moduleshop.php?m=mmjz_product&a=status&ajax=1",
				data:{
					id:item.id
				},
				dataType:"json",
		...
		recommendToggle:function(item){
			$.ajax({
				url:"/moduleshop.php?m=mmjz_product&a=recommend&ajax=1",
				data:{
					id:item.id
				},
				dataType:"json",
		...
		hotToggle:function(item){
			$.ajax({
				url:"/moduleshop.php?m=mmjz_product&a=hot&ajax=1",
				data:{
					id:item.id
				},
				dataType:"json",
