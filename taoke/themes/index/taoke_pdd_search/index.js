...
var app=new Vue({
	...
	methods:{
		...
		getPage:function(){
			var that=this;
			$.ajax({
				url:"/module.php?m=taoke_pdd_search&a=searchapi&ajax=1&word="+this.word,
				data:{
					catmap:this.catmap
				},
				dataType:"json",
		...
		goDetail:function(id){
			window.location="/module.php?m=taoke_pdd_search&a=show&id="+id;
		}
	}
})