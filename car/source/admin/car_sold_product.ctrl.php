...
class car_sold_productControl extends skymvc{
	...
	public function onDefault(){
		...
		$this->smarty->display("car_sold_product/index.html");
	}
	...
	public function onDelete(){
		...
		$id=get("productid","i");
		$row=M("mod_car_sold_product")->selectRow("productid=".$id);
		 
		M("mod_car_sold_product")->update(array("status"=>11),"productid=".$id);
	...
	public function onRecommend(){
		...
		$row=M("mod_car_sold_product")->selectRow("productid=".$productid);
		$status=1;
