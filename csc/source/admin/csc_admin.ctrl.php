<?php
class csc_adminControl extends skymvc{
	...
	public function onDefault(){
		...
		$where=" shopid=".$shopid;
		$url="/moduleadmin.php?m=csc_admin&a=default";
		$limit=24;
		...
		$rscount=true;
		$data=M("mod_csc_admin")->select($option,$rscount);
		...
		$this->smarty->display("csc_admin/index.html");	
	}
	public function onAdd(){
		$this->smarty->display("csc_admin/add.html");	
	}
	...
	public function onPasswordSave(){
		...
		M("mod_csc_admin")->update($data,"adminid=".$adminid);
		$this->goAll("密码修改成功");
	}
}