...
class jdo2o_shop_applyControl extends skymvc{
	...
	public function onDefault(){
		...
		$apply=M("mod_jdo2o_shop_apply")->selectRow("userid=".$userid);
	...
	public function onSendSms(){
		...
		$exkey="jdo2oshopapplysms".$telephone;
		$key="jdo2oshopapplysms".$telephone.$yzm;
		$t=cache()->get($exkey);
		if($t){
	...
	public function onSave(){
		...
		$data=M("mod_jdo2o_shop_apply")->postData();
		...
		$data["userid"]=$userid;
		M("mod_jdo2o_shop_apply")->insert($data);
