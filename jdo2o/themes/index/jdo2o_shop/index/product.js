Vue.component("shop-product",{
	...
	methods: {
		...
		getList: function() {
			...
			$.ajax({
				dataType: "json",
				url:  "/module.php?m=jdo2o_product&ajax=1&shopid=" + this.shopid,
				data: {
					catid: that.catid,
					type: that.type,
		...
		goOrder: function() {
			window.location = "/module.php?m=jdo2o_order&a=confirm&shopid=" + shopid;
		},
		goGuest: function() {
			window.location = "/module.php?m=jdo2o_guest&a=user&shopid=" + shopid;
		
		},
		goProduct: function(id) {
			window.location = "/module.php?m=jdo2o_product&a=show&id=" + id + "&shopid=" + shopid
		...
		statCart: function() {
			...
			$.ajax({
				dataType: "json",
				url: "/module.php?m=jdo2o_cart&a=statshop&ajax=1",
				data: {
					shopid: this.shopid
				},
				success: function(res) {
