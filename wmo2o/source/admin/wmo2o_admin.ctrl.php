...
class wmo2o_adminControl extends skymvc{
	...
	public function onDefault(){
		...
		$where=" shopid=".$shopid;
		$url="/moduleadmin.php?m=wmo2o_admin&a=default";
		$limit=24;
		...
		$rscount=true;
		$data=M("mod_wmo2o_admin")->select($option,$rscount);
	...
	public function onAdd(){
		$this->smarty->display("wmo2o_admin/add.html");	
	}
	...
	public function onPasswordSave(){
		...
		M("mod_wmo2o_admin")->update($data,"adminid=".$adminid);
		$this->goAll("密码修改成功");
	}
}