var App=new Vue({
	...
	methods:{
		getCache:function(){
			var v=localStorage.getItem("car_zhuce_my");
			if(v){
		...
		setCache:function(){
			...
			localStorage.setItem("car_zhuce_my",JSON.stringify(v));
		},
		...
		sendHb:function(){
			...
			$.ajax({
				url:"/module.php?m=car_zuche&a=hbpay&ajax=1",
				dataType:"json",
				data:{
		...
		updateItem:function(productid){
			var that=this;
			$.ajax({
				url:"/module.php?m=car_zuche&a=show&ajax=1",
				dataType:"json",
				data:{
					productid:productid
				},
		...
		copy:function(productid){
			window.location="/module.php?m=car_zuche&a=copy&productid="+productid;
		},
		goEdit:function(productid){
			window.location="/module.php?m=car_zuche&a=add&productid="+productid;
		},
		toggleStatus:function(item){
			var that=this;
			$.ajax({
				url:"/module.php?m=car_zuche&a=status&ajax=1&productid="+item.productid,
		...
		del:function(productid){
			...
			skyJs.confirm({
				...
				success:function(){
					$.ajax({
						url:"/module.php?m=car_zuche&a=delete&ajax=1&productid="+productid,
		...
		recommend:function(item){
			...
			skyJs.confirm({
				...
				success:function(){
					...
					$.ajax({
						url:"/module.php?m=car_zuche&a=recommend&ajax=1&productid="+item.productid,
		...
		getPage:function(){
			var that=this;
			$.ajax({
				url:"/module.php?m=car_zuche&a=my&ajax=1",
