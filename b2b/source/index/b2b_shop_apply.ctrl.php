...
class b2b_shop_applyControl extends skymvc{
	...
	public function onDefault(){
		...
		$apply=M("mod_b2b_shop_apply")->selectRow("userid=".$userid);
	...
	public function onSendSms(){
		...
		$exkey="b2bshopapplysms".$telephone;
		$key="b2bshopapplysms".$telephone.$yzm;
		if(SMS_TEST==true){
			cache()->set($key,1,300);
	...
	public function onSave(){
		...
		$data=M("mod_b2b_shop_apply")->postData();
		...
		$data["userid"]=$userid;
		M("mod_b2b_shop_apply")->insert($data);
