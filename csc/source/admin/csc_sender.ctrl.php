	...
	*/
	...
	class csc_senderControl extends skymvc{
		...
		public function onDefault(){
			...
			$url="/moduleadmin.php?m=csc_sender&a=default";
			$limit=20;
		...
		public function onShow(){
			...
			$data=M("mod_csc_sender")->selectRow(array("where"=>"senderid=".$senderid));
			$this->smarty->goassign(array(
				"data"=>$data
			));
			$this->smarty->display("csc_sender/show.html");
		}
		...
		public function onStatus(){
			...
			M("mod_csc_sender")->update(array("status"=>$status),"senderid=$senderid");
			$this->goall("状态修改成功",0,$status);
		}
		
		public function onDelete(){
			$senderid=get_post('senderid',"i");
			M("mod_csc_sender")->update(array("status"=>11),"senderid=$senderid");
			$this->goAll("删除成功");
