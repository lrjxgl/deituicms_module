	...
	*/
	...
	class dzp_orderControl extends skymvc{
		...
		public function onMy(){
			...
			$url="/module.php?m=dzp_order&a=my";
			$limit=24;
		...
		public function onShow(){
			...
			$data=M("mod_dzp_order")->selectRow(array("where"=>"orderid=".$orderid));
		...
		public function onChangeAddr(){
			$userid=M("login")->userid;
			$orderid=get_post('orderid',"i");
			$row=M("mod_dzp_order")->selectRow("orderid=".$orderid);
		...
		public function onReceived(){
			...
			M("mod_dzp_order")->update(array("status"=>3),"orderid=".$orderid);
