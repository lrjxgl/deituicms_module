<?php
class wmo2o_shoplistControl extends skymvc{
	...
	public function onDefault(){
		...
		if($catid){
			...
			$cat=MM("wmo2o","wmo2o_shop_category")->selectRow("catid=".$catid);
		}
		$order=" shopid DESC ";
		$fields=" * ";
		$gps=gps_get();
		...
		$orderList=MM("wmo2o","wmo2o_shop")->orderList();
		$filterList=array(
			"send_free"=>"免费配送",
			"send_all"=>"零元起送",
			"cspf"=>"超时赔付",
		...
		$rscount=true;
		$shopList=MM("wmo2o","wmo2o_shop")->DselectWindow($option,$rscount);
		...
		$this->smarty->display("wmo2o_shoplist/index.html");
	}
