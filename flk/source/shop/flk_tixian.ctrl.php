<?php
class flk_tixianControl extends skymvc{
	public $sw;
	public $k;
	...
	public function onList(){
		$limit=20;
		$where= $this->sw;
		$url="/moduleshop.php?m=flk_tixian";
		...
		$this->smarty->display("flk_tixian/list.html");
	}
	...
	public function onDefault(){
		...
		$bankList=M("mod_flk_bankcard")->select(array(
			"where"=>"shopid=".SHOPID
		));	
		$this->smarty->goassign(array(
			"shop"=>$shop,
		...
		$this->smarty->display("flk_tixian/index.html");
	}
	...
	public function onSave(){
		...
		$shop=M("mod_flk_shop_money")->selectRow("shopid=".SHOPID);
		...
		$bank=M("mod_flk_bankcard")->selectRow("id=".$bankid);
