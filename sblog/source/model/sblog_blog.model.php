<?php
class sblog_blogModel extends model{
	public $table="mod_sblog_blog";
	...
	public function parseContent($content){
		...
		if(isset($tps[1])){
			...
			foreach($tps[1] as $tp){
				$content=str_replace("#{$tp}#",'<a class="blogLink" href="/module.php?m=sblog_blog&a=topic&title='.urlencode(html($tp)).'">#'.html($tp).'#</a>',$content);
			}
		}
		return $content;
	}
