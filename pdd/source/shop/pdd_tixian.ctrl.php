<?php
class pdd_tixianControl extends skymvc{
	public $sw;
	public $k;
	...
	public function onList(){
		$limit=20;
		$where= $this->sw;
		$url="/moduleshop.php?m=pdd_tixian";
		...
		$this->smarty->display("pdd_tixian/list.html");
	}
	
	
	public function onDefault(){
		$shop=M("mod_pdd_shop")->selectRow("shopid=".SHOPID);
		$shopmoney=M("mod_pdd_shop_money")->selectRow("shopid=".SHOPID);
		...
		$this->smarty->display("pdd_tixian/index.html");
	}
	...
	public function onSave(){
		...
		$shop=M("mod_pdd_shop_money")->selectRow("shopid=".SHOPID);
		...
		$bank=M("mod_pdd_bankcard")->selectRow("id=".$bankid);
