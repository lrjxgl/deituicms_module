import * as THREE from '/plugin/threejs/build/three.module.js';
			...
			import { TeapotGeometry } from '/plugin/threejs/examples/jsm/geometries/TeapotGeometry.js';
			...
			function init() {
				...
				const textureMap = new THREE.TextureLoader().load( '/plugin/threejs/examples/textures/uv_grid_opengl.jpg' );
