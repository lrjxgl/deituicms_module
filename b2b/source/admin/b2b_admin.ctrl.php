<?php
class b2b_adminControl extends skymvc{
	...
	public function onDefault(){
		...
		$where=" shopid=".$shopid;
		$url="/moduleadmin.php?m=b2b_admin&a=default";
		$limit=24;
		...
		$rscount=true;
		$data=M("mod_b2b_admin")->select($option,$rscount);
		...
		$this->smarty->display("b2b_admin/index.html");	
	}
	public function onAdd(){
		$this->smarty->display("b2b_admin/add.html");	
	}
	...
	public function onPasswordSave(){
		...
		M("mod_b2b_admin")->update($data,"adminid=".$adminid);
		$this->goAll("密码修改成功");
	}
}