	...
	*/
	...
	class f2c_orderControl extends skymvc{
		...
		public function onDefault(){
			...
			$url="/moduleadmin.php?m=f2c_order&a=default";
			$limit=24;
			...
			$rscount=true;
			$data=M("mod_f2c_order")->select($option,$rscount);
			if($data){
				foreach($data as $v){
					$oids[]=$v["orderid"];
					$uids[]=$v["userid"];
			...
			$this->smarty->display("f2c_order/index.html");
		}
		...
		public function onConfirm(){
			...
			MM("f2c","f2c_order_log")->insert(array(
				"adminid"=>$adminid,
				"orderid"=>$orderid,
