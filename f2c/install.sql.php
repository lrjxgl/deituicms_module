...
CREATE TABLE `sky_mod_f2c_category` (
...
CREATE TABLE `sky_mod_f2c_config` (
  ...
  `shoptype` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '分销模式 0店铺 1邀请',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4;
CREATE TABLE `sky_mod_f2c_config_rank` (
...
CREATE TABLE `sky_mod_f2c_done` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `teamid` int(10) unsigned NOT NULL DEFAULT '0',
  `smonth` int(10) unsigned NOT NULL DEFAULT '0',
  `money` decimal(13,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '营业额',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `createtime` datetime NOT NULL DEFAULT '2019-03-14 03:28:01',
  `income` decimal(13,2) unsigned DEFAULT '0.00' COMMENT '收入',
  PRIMARY KEY (`id`),
  KEY `teamid` (`teamid`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE `sky_mod_f2c_group` (
...
CREATE TABLE `sky_mod_f2c_group_product` (
...
CREATE TABLE `sky_mod_f2c_order` (
  ...
  `goods_money` decimal(13,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '产品价格',
  ...
  `teamid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '代理',
  `finishtime` datetime NOT NULL DEFAULT '2019-03-16 10:57:01',
  PRIMARY KEY (`orderid`),
  KEY `userid` (`userid`) USING BTREE,
  KEY `orderno` (`orderno`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4;
CREATE TABLE `sky_mod_f2c_order_address` (
...
CREATE TABLE `sky_mod_f2c_order_data` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sky_mod_f2c_order_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sky_mod_f2c_order_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `orderid` int(11) NOT NULL DEFAULT '0',
  `userid` int(11) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_f2c_order_raty` (
...
CREATE TABLE `sky_mod_f2c_product` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `buy_month_num` int(10) unsigned NOT NULL DEFAULT '0',
  ...
  `per_money` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '抽成比例',
  `fanli` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '返利',
  `view_num` tinyint(3) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `catid_status` (`catid`,`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=159 DEFAULT CHARSET=utf8mb4;
CREATE TABLE `sky_mod_f2c_product_data` (
  `id` int(10) unsigned NOT NULL,
  `content` mediumtext CHARACTER SET utf8,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='产品';
CREATE TABLE `sky_mod_f2c_product_ks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sky_mod_f2c_team` (
  ...
  `team_money` decimal(13,2) unsigned NOT NULL DEFAULT '0.00',
  PRIMARY KEY (`teamid`),
  KEY `userid` (`userid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4;
CREATE TABLE `sky_mod_f2c_team_apply` (
  `teamid` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(32) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '名称',
  `nickname` varchar(16) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '昵称',
  `telephone` varchar(15) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '电话',
...
CREATE TABLE `sky_mod_f2c_team_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `teamid` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_f2c_user` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `userid` int(10) unsigned NOT NULL DEFAULT '0',
  `grade` int(10) unsigned NOT NULL DEFAULT '0',
  `money` decimal(11,2) unsigned NOT NULL DEFAULT '0.00',
  `team_money` decimal(15,2) unsigned NOT NULL DEFAULT '0.00',
  PRIMARY KEY (`id`),
  KEY `userid` (`userid`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
