...
var app = new Vue({
	...
	methods: {
		goProduct:function(shopid,id){
			window.location="/module.php?m=b2b_product&a=show&shopid="+shopid+"&id="+id;
		},
		getPage: function() {
			var that = this;
			$.get("/module.php?m=b2b_prolist&ajax=1", function(res) {
		...
		getList:function(){
			...
			$.ajax({
				url:"/module.php?m=b2b_prolist&ajax=1",
				data:{
					catid:catid,
					per_page:per_page
				},
