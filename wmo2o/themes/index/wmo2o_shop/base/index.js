...
new Vue ({
		...
		methods: {
			...
			getPin:function(){
				var that = this;
				$.ajax({
					url: "/module.php?m=wmo2o_shop&a=recommend&ajax=1&shopid=" + shopid,
					dataType:"json",
			...
			getPage: function() {
				var that = this;
				$.ajax({
					url:   "/module.php?m=wmo2o_shop&ajax=1&shopid=" + shopid,
					dataType:"json",
					success: function(res) {
					 
						that.wmo2o_num=res.data.wmo2o_num;
			...
			getList: function() {
				...
				$.ajax({
					url:  "/module.php?m=wmo2o_product&ajax=1&shopid=" + shopid,
					data: {
						catid: that.catid,
						type:that.type,
