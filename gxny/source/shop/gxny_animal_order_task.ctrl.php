...
class gxny_animal_order_taskControl extends skymvc{
	...
	public function onDefault(){
		...
		$where=" shopid=".SHOPID;
		$url="/moduleshop.php?m=gxny_animal_order_task";
		$type=get("type","h");
		switch($type){
			case "new":
		...
		$rscount=true;
		$data=M("mod_gxny_animal_order_task")->select($option,$rscount);
		...
		$this->smarty->display("gxny_animal_order_task/index.html");
	}
	public function onFinish(){
		$taskid=get("taskid","i");
		$task=MM("gxny","gxny_animal_order_task")->selectRow("taskid=".$taskid);
		MM("gxny","gxny_animal_order_task")->update(array(
