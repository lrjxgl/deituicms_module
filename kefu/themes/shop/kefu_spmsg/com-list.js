			...
			<div class="chatbox" v-else>
				...
				<div class="w200">
					...
					<div class="mgb-5 flex-ai-center flex">
						<div class="flex-1"></div>
						<div class="cl2 mgr-5">{{kefu.title}}</div>
						<div class="cl3 f12">{{item.timeago}}</div>
					</div>
				...
				<img :src="kefu.user_head+'.100x100.jpg'" class="wh-40 mgl-10" />
			</div>
		</div>
		<div v-if="bigModal">
