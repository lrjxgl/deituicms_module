...
class flk_adminControl extends skymvc{
	...
	public function onDefault(){
		...
		$where=" shopid=".$shopid;
		$url="/moduleadmin.php?m=flk_admin&a=default";
		$limit=24;
		...
		$rscount=true;
		$data=M("mod_flk_admin")->select($option,$rscount);
	...
	public function onAdd(){
		$this->smarty->display("flk_admin/add.html");	
	}
	...
	public function onPasswordSave(){
		...
		M("mod_flk_admin")->update($data,"adminid=".$adminid);
		$this->goAll("密码修改成功");
	}
}