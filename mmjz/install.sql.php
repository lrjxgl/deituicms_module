<?php
$content=<<<eof
CREATE TABLE `sky_mod_mmjz_admin` (
...
CREATE TABLE `sky_mod_mmjz_article` (
...
CREATE TABLE `sky_mod_mmjz_article_comment` (
...
CREATE TABLE `sky_mod_mmjz_article_data` (
  `id` int(10) unsigned NOT NULL,
  `content` mediumtext CHARACTER SET utf8,
  `shopid` int(10) unsigned DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE `sky_mod_mmjz_auth_user` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sky_mod_mmjz_bankcard` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sky_mod_mmjz_blog` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `userid` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_mmjz_blog_comment` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `userid` int(10) unsigned NOT NULL DEFAULT '0',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_mmjz_blog_view` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `objectid` int(10) unsigned NOT NULL DEFAULT '0',
  `userid` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_mmjz_brand` (
...
CREATE TABLE `sky_mod_mmjz_cart` (
...
CREATE TABLE `sky_mod_mmjz_category` (
...
CREATE TABLE `sky_mod_mmjz_cbd_shop` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sky_mod_mmjz_coupon` (
...
CREATE TABLE `sky_mod_mmjz_coupon_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sky_mod_mmjz_express_fee` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sky_mod_mmjz_express_fee_city` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sky_mod_mmjz_group` (
...
CREATE TABLE `sky_mod_mmjz_group_product` (
...
CREATE TABLE `sky_mod_mmjz_guest` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sky_mod_mmjz_guestindex` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `createtime` datetime NOT NULL DEFAULT '2019-02-23 05:31:01' COMMENT '创建时间',
  `userid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户',
  `shopid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户2',
...
CREATE TABLE `sky_mod_mmjz_hotvip` (
  ...
  PRIMARY KEY (`vid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='上热门产品';
CREATE TABLE `sky_mod_mmjz_order` (
  ...
  `fromsite` varchar(12) CHARACTER SET utf8 NOT NULL DEFAULT 'mmjz' COMMENT '来源站点 b2c 独立建站  mmjz平台订单',
  PRIMARY KEY (`orderid`),
  KEY `userid` (`userid`) USING BTREE,
  KEY `orderno` (`orderno`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE `sky_mod_mmjz_order_address` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sky_mod_mmjz_order_code` (
...
CREATE TABLE `sky_mod_mmjz_order_data` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `orderid` int(10) unsigned NOT NULL DEFAULT '0',
  `userid` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_mmjz_order_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sky_mod_mmjz_order_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `orderid` int(11) NOT NULL DEFAULT '0',
  `userid` int(11) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_mmjz_order_raty` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_mmjz_product` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `iswindow` tinyint(3) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_mmjz_product_data` (
  `id` int(10) unsigned NOT NULL,
  `content` mediumtext CHARACTER SET utf8,
  `shopid` int(10) unsigned DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
CREATE TABLE `sky_mod_mmjz_product_ks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned DEFAULT '0',
...
CREATE TABLE `sky_mod_mmjz_report` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0',
  `userid` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_mmjz_shop` (
...
CREATE TABLE `sky_mod_mmjz_shop_apply` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(32) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '名称',
...
CREATE TABLE `sky_mod_mmjz_shop_category` (
  `catid` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(16) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `pid` int(10) unsigned NOT NULL DEFAULT '0',
  `orderindex` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_mmjz_shop_cert` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '0',
  ...
  PRIMARY KEY (`id`),
  KEY `shopid` (`shopid`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商家证件';
CREATE TABLE `sky_mod_mmjz_shop_commission` (
...
CREATE TABLE `sky_mod_mmjz_shop_earnest` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sky_mod_mmjz_shop_earnest_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL COMMENT '商家',
  `createtime` datetime NOT NULL DEFAULT '2018-08-24 00:00:00' COMMENT '创建时间',
...
CREATE TABLE `sky_mod_mmjz_shop_earnest_refund` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL COMMENT '商家',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `createtime` datetime NOT NULL DEFAULT '2018-08-24 00:00:00' COMMENT '创建时间',
...
CREATE TABLE `sky_mod_mmjz_shop_hotvip` (
  ...
  KEY `shopid` (`shopid`),
  KEY `vid` (`vid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商家上热门';
CREATE TABLE `sky_mod_mmjz_shop_hotvip_user` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '商家',
  `vid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'vip',
...
CREATE TABLE `sky_mod_mmjz_shop_money` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_mmjz_shop_money_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL COMMENT '商家',
  `createtime` datetime NOT NULL DEFAULT '2018-08-24 00:00:00' COMMENT '创建时间',
...
CREATE TABLE `sky_mod_mmjz_shop_notice` (
...
CREATE TABLE `sky_mod_mmjz_shop_openbind` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_mmjz_shop_paypwd` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_mmjz_shop_product_category` (
  `catid` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(16) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `pid` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_mmjz_shop_safephone` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_mmjz_video` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(225) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '标题',
...
CREATE TABLE `sky_mod_mmjz_view_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
