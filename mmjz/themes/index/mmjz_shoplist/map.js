...
function getshop(){
	$.ajax({
		url:"/module.php?m=mmjz_shoplist&ajax=1",
		dataType:"json",
...
function clickInfo(i,shop,point){
	...
	var sContent=`
		<div style="width:300px;height:140px;padding:10px;z-index:999;position:relative">
			...
			<div class="none">
				...
				<a class="cl-primary mgr-10" href="/module.php?m=mmjz_shop&shopid=`+shop.shopid+`">去看看</a>
			</div>
	...
	markers[i].addEventListener('click', function(){
		...
		console.log(shop)
		$("#goshop").show().attr("href","/module.php?m=mmjz_shop&shopid="+shop.shopid);
	});
