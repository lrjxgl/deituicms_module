<?php
class freeshop_tixianControl extends skymvc{
	public $sw;
	public $k;
	public $shopid;
	public function __construct(){
		parent::__construct();	
		$this->k="mod_freeshop_shop";
	...
	public function onList(){
		$limit=20;
		$where= $this->sw;
		$url="/module.php?m=freeshop_tixian";
		...
		$this->smarty->display("freeshop_tixian/list.html");
	}
	...
	public function onDefault(){
		...
		$bankList=M("mod_freeshop_bankcard")->select(array(
		...
		$this->smarty->display("freeshop_tixian/index.html");
	}
	...
	public function onSave(){
		...
		$shop=M("mod_freeshop_shop_money")->selectRow("shopid=".$this->shopid);
		...
		$bank=M("mod_freeshop_bankcard")->selectRow("id=".$bankid);
