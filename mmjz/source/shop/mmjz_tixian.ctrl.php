<?php
class mmjz_tixianControl extends skymvc{
	public $sw;
	public $k;
	public function __construct(){
		parent::__construct();	
		$this->k="mod_mmjz_shop";
	...
	public function onList(){
		$limit=20;
		$where= $this->sw;
		$url="/moduleshop.php?m=mmjz_tixian";
		...
		$this->smarty->display("mmjz_tixian/list.html");
	}
	...
	public function onDefault(){
		...
		$this->smarty->display("mmjz_tixian/index.html");
	}
	...
	public function onSave(){
		...
		$shop=M("mod_mmjz_shop_money")->selectRow("shopid=".SHOPID);
