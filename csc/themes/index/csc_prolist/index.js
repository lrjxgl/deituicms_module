...
var app = new Vue({
	...
	methods: {
		...
		getPage: function() {
			var that = this;
			$.get("/module.php?m=csc_prolist&ajax=1", function(res) {
		...
		getList:function(){
			...
			$.ajax({
				url:"/module.php?m=csc_prolist&ajax=1",
				data:{
					catid:catid,
					per_page:per_page
				},
		...
		ksBox:function(id){
			var that=this;
			$.ajax({
				url:"/module.php?m=csc_product_ks&ajax=1&productid="+id,
				dataType:"json",
				success:function(res){
					that.ksShow=true;
		...
		ks1:function(id){
			var that=this;
			$.ajax({
				url:"/module.php?m=csc_product_ks&a=sizeList&ajax=1&id="+id,
				dataType:"json",
				success:function(res){
					that.ksid1=res.data.ksid;
					that.ksid=res.data.ksid;
		...
		ks2:function(id){
			...
			that.ksid=id;
			 $.ajax({
			 	url:"/module.php?m=csc_product_ks&a=get&ajax=1&id="+id,
			 	dataType:"json",
			 	success:function(res){
