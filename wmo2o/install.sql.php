<?php
$content=<<<eof
CREATE TABLE `sky_mod_wmo2o_admin` (
...
CREATE TABLE `sky_mod_wmo2o_article` (
...
CREATE TABLE `sky_mod_wmo2o_article_comment` (
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='银行账号';
CREATE TABLE `sky_mod_wmo2o_blog` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  ...
  `imgsdata` text CHARACTER SET utf8 COMMENT '图集',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='微博客';
CREATE TABLE `sky_mod_wmo2o_blog_comment` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `userid` int(10) unsigned NOT NULL DEFAULT '0',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_wmo2o_blog_view` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `objectid` int(10) unsigned NOT NULL DEFAULT '0',
  `userid` int(10) unsigned NOT NULL DEFAULT '0',
  ...
  KEY `userid` (`userid`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='分类浏览记录';
CREATE TABLE `sky_mod_wmo2o_cart` (
...
CREATE TABLE `sky_mod_wmo2o_category` (
  ...
  PRIMARY KEY (`catid`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COMMENT='分类';
CREATE TABLE `sky_mod_wmo2o_cbd` (
  ...
  `tagno` varchar(255) NOT NULL DEFAULT '' COMMENT '标签',
  PRIMARY KEY (`cbdid`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COMMENT='商圈';
CREATE TABLE `sky_mod_wmo2o_cbd_shop` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8mb4 COMMENT='商圈商家';
CREATE TABLE `sky_mod_wmo2o_coupon` (
...
CREATE TABLE `sky_mod_wmo2o_coupon_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sky_mod_wmo2o_express_fee` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sky_mod_wmo2o_express_fee_city` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sky_mod_wmo2o_group` (
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COMMENT='产品聚合';
CREATE TABLE `sky_mod_wmo2o_group_product` (
...
) ENGINE=InnoDB AUTO_INCREMENT=147 DEFAULT CHARSET=utf8mb4 COMMENT='产品聚合';
CREATE TABLE `sky_mod_wmo2o_guest` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8mb4 COMMENT='咨询索引';
CREATE TABLE `sky_mod_wmo2o_guestindex` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `createtime` datetime NOT NULL DEFAULT '2019-02-23 05:31:01' COMMENT '创建时间',
  `userid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户',
  `shopid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户2',
  ...
  KEY `userid` (`userid`) USING BTREE,
  KEY `objectid_userid` (`productid`,`userid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COMMENT='咨询索引';
CREATE TABLE `sky_mod_wmo2o_hotvip` (
  ...
  `num` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '人气',
  PRIMARY KEY (`vid`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='上热门产品';
CREATE TABLE `sky_mod_wmo2o_offpay` (
  ...
  `status` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `createtime` datetime NOT NULL DEFAULT '2022-03-02 19:10:11',
  `recharge_id` int(10) unsigned NOT NULL DEFAULT '0',
  `paytype` varchar(16) NOT NULL DEFAULT '',
  PRIMARY KEY (`orderid`),
  KEY `userid` (`userid`),
  KEY `shopid` (`shopid`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='优惠买单';
CREATE TABLE `sky_mod_wmo2o_order` (
  ...
  `fromsite` varchar(12) CHARACTER SET utf8 NOT NULL DEFAULT 'wmo2o' COMMENT '来源站点 b2c 独立建站  wmo2o平台订单',
  `paotui_id` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '跑腿id',
  PRIMARY KEY (`orderid`),
  KEY `userid` (`userid`) USING BTREE,
  KEY `orderno` (`orderno`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='订单';
CREATE TABLE `sky_mod_wmo2o_order_address` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sky_mod_wmo2o_order_code` (
...
CREATE TABLE `sky_mod_wmo2o_order_data` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `orderid` int(10) unsigned NOT NULL DEFAULT '0',
  `userid` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_wmo2o_order_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sky_mod_wmo2o_order_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `orderid` int(11) NOT NULL DEFAULT '0',
  `userid` int(11) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_wmo2o_order_raty` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_wmo2o_product` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=1213 DEFAULT CHARSET=utf8mb4 COMMENT='产品';
CREATE TABLE `sky_mod_wmo2o_product_data` (
  `id` int(10) unsigned NOT NULL,
  `content` mediumtext CHARACTER SET utf8,
  `shopid` int(10) unsigned DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='产品';
CREATE TABLE `sky_mod_wmo2o_product_ks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned DEFAULT '0',
...
CREATE TABLE `sky_mod_wmo2o_report` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0',
  `userid` int(10) unsigned NOT NULL DEFAULT '0',
  ...
  PRIMARY KEY (`id`),
  KEY `userid` (`userid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='举报';
CREATE TABLE `sky_mod_wmo2o_shop` (
  ...
  PRIMARY KEY (`shopid`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COMMENT='商家';
CREATE TABLE `sky_mod_wmo2o_shop_apply` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(32) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '名称',
...
CREATE TABLE `sky_mod_wmo2o_shop_category` (
  `catid` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(16) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `pid` int(10) unsigned NOT NULL DEFAULT '0',
  `orderindex` int(10) unsigned NOT NULL DEFAULT '0',
  ...
  `description` varchar(225) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '描述',
  PRIMARY KEY (`catid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='分类';
CREATE TABLE `sky_mod_wmo2o_shop_cert` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '0',
  ...
  PRIMARY KEY (`id`),
  KEY `shopid` (`shopid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='商家证件';
CREATE TABLE `sky_mod_wmo2o_shop_commission` (
...
CREATE TABLE `sky_mod_wmo2o_shop_earnest` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `sky_mod_wmo2o_shop_earnest_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL COMMENT '商家',
  `createtime` datetime NOT NULL DEFAULT '2018-08-24 00:00:00' COMMENT '创建时间',
...
CREATE TABLE `sky_mod_wmo2o_shop_earnest_refund` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL COMMENT '商家',
  `status` tinyint(3) unsigned NOT NULL DEFAULT '0',
  `createtime` datetime NOT NULL DEFAULT '2018-08-24 00:00:00' COMMENT '创建时间',
...
CREATE TABLE `sky_mod_wmo2o_shop_hotvip` (
  `spid` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '商家',
  `vid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'vip',
  `price` decimal(9,2) NOT NULL DEFAULT '0.00' COMMENT '价格',
  `num` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '人气',
  `ispay` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否支付',
  `has_num` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '访问人数',
  `createtime` datetime NOT NULL DEFAULT '2022-01-06 09:04:01' COMMENT '创建时间',
  `isfinish` tinyint(3) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`spid`),
  KEY `shopid` (`shopid`),
  KEY `vid` (`vid`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='商家上热门';
CREATE TABLE `sky_mod_wmo2o_shop_hotvip_user` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '商家',
  `vid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'vip',
  `spid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'vip',
  `userid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'vip',
  `createtime` datetime NOT NULL DEFAULT '2022-01-06 09:04:01' COMMENT '创建时间',
  PRIMARY KEY (`id`),
  KEY `shopid` (`shopid`),
  KEY `vid` (`vid`),
  KEY `spid` (`spid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商用户访问';
CREATE TABLE `sky_mod_wmo2o_shop_money` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0',
  ...
  PRIMARY KEY (`id`),
  KEY `shopid` (`shopid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='商家资金';
CREATE TABLE `sky_mod_wmo2o_shop_money_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL COMMENT '商家',
  `createtime` datetime NOT NULL DEFAULT '2018-08-24 00:00:00' COMMENT '创建时间',
...
CREATE TABLE `sky_mod_wmo2o_shop_notice` (
...
CREATE TABLE `sky_mod_wmo2o_shop_openbind` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_wmo2o_shop_paypwd` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `sky_mod_wmo2o_shop_product_category` (
  `catid` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(16) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `pid` int(10) unsigned NOT NULL DEFAULT '0',
  ...
  `description` varchar(225) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '描述',
  PRIMARY KEY (`catid`)
) ENGINE=InnoDB AUTO_INCREMENT=305 DEFAULT CHARSET=utf8mb4 COMMENT='分类';
CREATE TABLE `sky_mod_wmo2o_shop_safephone` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0',
  `telephone` varchar(15) CHARACTER SET utf8 NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `shopid` (`shopid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='安全手机';
CREATE TABLE `sky_mod_wmo2o_video` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `shopid` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(225) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '标题',
...
CREATE TABLE `sky_mod_wmo2o_view_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COMMENT='店铺访问客户';
