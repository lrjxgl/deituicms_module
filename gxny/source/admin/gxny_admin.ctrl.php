...
class gxny_adminControl extends skymvc{
	...
	public function onDefault(){
		...
		$where=" shopid=".$shopid;
		$url="/moduleadmin.php?m=gxny_admin&a=default";
		$limit=24;
		...
		$rscount=true;
		$data=M("mod_gxny_admin")->select($option,$rscount);
	...
	public function onAdd(){
		$this->smarty->display("gxny_admin/add.html");	
	}
	...
	public function onPasswordSave(){
		...
		M("mod_gxny_admin")->update($data,"adminid=".$adminid);
		$this->goAll("密码修改成功");
	}
}