<?php
class mmjz_shop_moneyControl extends skymvc{
	...
	public function onDefault(){
		...
		$list=M("mod_mmjz_shop_money_log")->select(array(
			"where"=>"shopid=".SHOPID,
			"order"=>"id DESC",
			"limit"=>48
		)); 
		...
		$this->smarty->display("mmjz_shop_money/index.html");
	}
	...
	public function onRecharge(){
		...
		$this->smarty->display("mmjz_shop_money/recharge.html");
	}
