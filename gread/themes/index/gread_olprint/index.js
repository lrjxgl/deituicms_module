	...
	methods: {
		statMoney: function() {
			...
			if (bookid > 0) {
				...
				var money = this.print_num * ((this.page_num - 1) * parseInt(this.optype.page_money * 100) +
					parseInt(this.optype.start_money * 100)) / 100;
			}
			if (this.sendtype == 1) {
		...
		getPage: function() {
			...
			$.ajax({
				...
				success: function(res) {
					if(res.error){
						window.location="/module.php?m=olprint_shoplist"
						return false;
					}
