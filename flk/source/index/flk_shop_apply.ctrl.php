...
class flk_shop_applyControl extends skymvc{
	...
	public function onDefault(){
		...
		$apply=M("mod_flk_shop_apply")->selectRow("userid=".$userid);
	...
	public function onSendSms(){
		...
		$exkey="flkshopapplysms".$telephone;
		$key="flkshopapplysms".$telephone.$yzm;
		$t=cache()->get($exkey);
		if($t){
	...
	public function onSave(){
		...
		$data=M("mod_flk_shop_apply")->postData();
		...
		$data["userid"]=$userid;
		M("mod_flk_shop_apply")->insert($data);
