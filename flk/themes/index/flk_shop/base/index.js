...
new Vue ({
		...
		methods: {
			...
			getPin:function(){
				var that = this;
				$.ajax({
					url: "/module.php?m=flk_shop&a=recommend&ajax=1&shopid=" + shopid,
					dataType:"json",
			...
			getPage: function() {
				var that = this;
				$.ajax({
					url:   "/module.php?m=flk_shop&ajax=1&shopid=" + shopid,
					dataType:"json",
					success: function(res) {
						res.data.shop.flk_discount=res.data.shop.flk_discount*100;
						that.flks=res.data.flks;
						that.flk_num=res.data.flk_num;
			...
			getList: function() {
				...
				$.ajax({
					url:  "/module.php?m=flk_product&ajax=1&shopid=" + shopid,
					data: {
						catid: that.catid,
						type:that.type,
