<?php
class test_householdControl extends skymvc{
	public $md="household";
	...
	public function onGroup(){
		M("mod_household_group")->delete("1");
		
		$gid=M("mod_household_group")->insert(array(
			"title"=>"推荐",
			"gkey"=>"recommend",
			"gnum"=>12,
			"status"=>1
		));
		$gid2=M("mod_household_group")->insert(array(
			"title"=>"推荐",
			"gkey"=>"hot",
			"gnum"=>12,
			"status"=>1
		));
		$list=M("mod_household_product")->selectCols(array(
			"where"=>" status=1 ",
			"limit"=>24
		));
