<?php
class jdo2o_view_userModel extends model{
	public $table="mod_jdo2o_view_user";
	...
	public function add($shopid,$userid){
		...
		if($row){
			...
			MM("jdo2o","jdo2o_push")->sendShop(array(
				"table"=>"mod_jdo2o_shop",
				"shopid"=>$shopid,
				"content"=>array(
				...
				"url"=>HTTP_HOST."/shopadmin.php?m=jdo2o_view_user&type=view",
				"linkurl"=>array(
					"path"=>"/moduleshop.php",
					"m"=>"jdo2o_view_user",
					"a"=>"view",
