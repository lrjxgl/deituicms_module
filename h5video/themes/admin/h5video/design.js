...
var App=new Vue({
	...
	methods:{
		...
		getPage:function(){
			var that=this;
			$.ajax({
				url:"/moduleadmin.php?m=h5video&a=data&ajax=1&vid="+vid,
				dataType:"json",
		...
		savePage:function(el){
			...
			this.addPageCss="";
			$.ajax({
				url:"/moduleadmin.php?m=h5video_page&a=save&ajax=1",
				dataType:"json",
				data:$(el).serialize(),
				method:"POST",
				success:function(res){
		...
		delPage:function(pageid){
			...
			if(confirm("确认删除吗")){
				$.ajax({
					url:"/moduleadmin.php?m=h5video_page&a=delete&ajax=1&pageid="+pageid,
					dataType:"json",
					success:function(res){
						that.getPage();
					}
		...
		setPage:function(pageid){
			...
			that.pageTab="design";
			$.ajax({
				url:"/moduleadmin.php?m=h5video_page&a=items&ajax=1&pageid="+pageid,
				dataType:"json",
				success:function(res){
		...
		saveItem:function(obj){
			var that=this;
			$.ajax({
				url:"/moduleadmin.php?m=h5video_page_item&a=save&ajax=1",
				dataType:"json",
				data:$(obj).serialize(),
				method:"POST",
				success:function(res){
		...
		delItem:function(id){
			if(confirm("确认删除吗")){
				var that=this;
				$.ajax({
					url:"/moduleadmin.php?m=h5video_page_item&a=delete&ajax=1&id="+id,
					dataType:"json",
					success:function(res){
						that.pageData=res.data;
						that.pageLoad=true;
