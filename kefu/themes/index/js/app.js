var wshost="ws://www.deitui.com:8383";
function replace_img(str){
	return str.replace(/\[:img-(\d+)\]/g ,"<img class=\"msg-r-img js-bigimg\" src=\"/index.php?m=attach&a=getimg&id=$1\" bsrc=\"index.php?m=attach&a=getimg&type=base&id=$1\">");
}
...
$(function(){
	...
	$(document).on("click",".js-kefu-user",function(){
		var html='<iframe class="kframe" src="/module.php?m=kefu&a=user&kfid='+$(this).attr("kfid")+'"></iframe>';
		showbox("客服",html,320,300);
	})
	$(document).on("click",".js-kefu-shop",function(){
		var html='<iframe class="kframe" src="/module.php?m=kefu&a=shop&kfid='+$(this).attr("kfid")+'&userid='+$(this).attr("userid")+'"></iframe>';
		showbox("客服",html,320,300);
	})
