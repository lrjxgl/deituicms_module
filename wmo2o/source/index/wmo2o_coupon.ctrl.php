	...
	*/
	...
	class wmo2o_couponControl extends skymvc{
		...
		public function onDefault(){
			...
			$url="/module.php?m=wmo2o_coupon&a=default";
			$limit=24;
		...
		public function onShow(){
			...
			$this->smarty->display("wmo2o_coupon/show.html");
		}
		
		public function onGetCoupon(){
			M("login")->checklogin(1);
			$id=get('id','i');
			$coupon=M("mod_wmo2o_coupon")->selectRow("id=".$id);
			if($coupon['status']!=1){
				$this->goAll("优惠券不可用",1);
			...
			$ct=M("mod_wmo2o_coupon_user")->SelectOne(array(
			...
			//更新优惠券领取人数
			M("mod_wmo2o_coupon")->update(array(
