...
var app = new Vue({
	...
	methods: {
		...
		getPage: function() {
			var that = this;
			$.ajax({
				url: "/moduleshop.php?m=kefu_spmsg&ajax=1",
				data: {
					kfid: kfid,
					userid: userid
				},
		...
		getList: function() {
			...
			$.ajax({
				dataType: "json",
				url: "/moduleshop.php?m=kefu_spmsg&a=list&ajax=1",
				data: {
		...
		submit: function() {
			...
			$.ajax({
				url: "/moduleshop.php?m=kefu_spmsg&a=save&ajax=1",
				dataType: "json",
				type: "POST",
				data: {
